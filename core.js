    ...
    init: function game_init(updateFunc, renderFunc, fpsFunc) {
      ...
      if (fpsFunc) {
        if (typeof fpsFunc === "function") {
          ...
          console.error(
            "[Tangle.main] >> Provided argument fpsFunc is not a function."
          );
        }
      }
      ...
      if (updateFunc && typeof updateFunc === "function") {
        ...
        _updateLoop = null;
        console.error(
          "[Tangle.main] >> Provided argument updateFunc is null or not a function."
        );
      }
      ...
      if (renderFunc && typeof renderFunc === "function") {
        ...
        _renderLoop = null;
        console.error(
          "[Tangle.main] >> Provided argument renderFunc is null or not a function."
        );
      }
    },
